...
SECURE_USERS = ["amit", "rahul", "ajad", "jitender","ramniwas",'lakshman","prempatil","mithlesh","dharmendra","deepak","rajan","shyamjeesharma","surjesh","bittu","prakashkumarjha","rittin"]
